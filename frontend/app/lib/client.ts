...
export function Environment(name: string): BaseURL {
    return `https://${name}-purfect-backend-w2f2.encr.app`
}
...
/**
 * Client is an API client for the purfect-backend-w2f2 Encore application.
 */
...
class BaseClient {
    ...
    constructor(baseURL: string, options: ClientOptions) {
        ...
        if (typeof window === "undefined") {
            this.headers["User-Agent"] = "purfect-backend-w2f2-Generated-TS-Client (Encore/v1.43.8)";
        }
